...
public class ProductMgr {
	...
	public ArrayList<ProductBean> getProductAll(){ //제품 가져오기
	...
	public boolean insertProduct(HttpServletRequest request) { //제품 등록
		boolean b = false;
		try {
			//업로드할 이미지 경로(절대 경로)
			String uploadDir ="C:/Users/82107/eclipse-workspace/ordertest/WebContent/data";
	...
	public ProductBean getProduct(String no) { //제품 가져오기
	...
	public boolean updateProduct(HttpServletRequest request) { //제품 수정
		boolean b = false;
		try {
			String uploadDir ="C:/Users/82107/eclipse-workspace/ordertest/WebContent/data";
			//MultipartRequest multi=new MultipartRequest(request, savePath, sizeLimit, new DefaultFileRenamePolicy());
	...
	public boolean deleteProduct(String no) { //제품 삭제
		boolean b = false;
		try {
			conn = ds.getConnection();
	...
	public void reduceProduct(OrderBean order) { //제품 수량 감소
		try {
			conn = ds.getConnection();
