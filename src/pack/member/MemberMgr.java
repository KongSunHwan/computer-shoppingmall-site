...
public class MemberMgr {
	...
	public ArrayList<ZipcodeBean> addressRead(String p_area3) { //주소 데이터 가져오기
	...
	public boolean memInsert(MemberBean bean) { // 회원가입
		boolean b = false;
		try {
			conn = ds.getConnection();
	...
	public boolean loginCheck(String id, String passwd) { //로그인 체크
		boolean b = false;
		try {
			conn = ds.getConnection();
