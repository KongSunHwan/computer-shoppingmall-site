...
<table border ="1" class="table table-striped table-bordered">
	...
	<td colspan="2" style="text-align: center";>
		<input type="button" class="btn btn-primary" value="수정 완료" onclick="check()">
		&nbsp;
		<input type="button" class="btn btn-primary" value="목록보기" onclick="location.href='boardlist.jsp?page=<%=spage%>'">
	</tr>
</table>
